...
public class SwerveKinematics {
	...
	public void calculate(double x, double y, double rotate) {
		double A = x - rotate * (NumberConstants.kWheelbaseLength / NumberConstants.kSwerveDiagonal);
		double B = x + rotate * (NumberConstants.kWheelbaseLength / NumberConstants.kSwerveDiagonal);
		double C = y - rotate * (NumberConstants.kWheelbaseWidth / NumberConstants.kSwerveDiagonal);
		double D = y + rotate * (NumberConstants.kWheelbaseWidth / NumberConstants.kSwerveDiagonal);
