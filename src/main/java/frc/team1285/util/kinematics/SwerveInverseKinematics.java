...
public class SwerveInverseKinematics {
	...
	private List<Translation2d> moduleRelativePositions = NumberConstants.kModulePositions;
	...
	public void setCenterOfRotation(Translation2d center) {
		...
		for (int i = 0; i < kNumberOfModules; i++) {
			Translation2d position = NumberConstants.kModulePositions.get(i).translateBy(center.inverse());
