...
public class Util {
    ...
    /**
     * Takes the current encoder reading and the desired setpoint and returns
     * the appropriate setpoint relative to the current encoder value.
     * 
     * Ex. if the encoder reads 480 degs and the setpoint is 30 degs,
     * the returned setpoint will be 390 degs.
     * 
     * @param scopeReference
     * @param newAngle
     * @return new setpoint angle
     */
